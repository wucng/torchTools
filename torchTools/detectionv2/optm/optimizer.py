...
def build_optimizer(model: torch.nn.Module,cfg
    ...
    """
    clip_gradients = cfg["work"]["optimizer"]["clip_gradients"]
    base_lr = cfg["work"]["optimizer"]["base_lr"]
    weight_decay = cfg["work"]["optimizer"]["weight_decay"]
    momentum = cfg["work"]["optimizer"]["momentum"]
    clip_type = cfg["work"]["optimizer"]["clip_type"]
...
def build_lr_scheduler(
    ...
    """
    name = cfg["work"]["optimizer"]["lr_scheduler_name"]
