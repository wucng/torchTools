...
class Center(nn.Module):
    def __init__(self,cfg):
        ...
        self.loss_func = centerLoss.CenterLoss(cfg, self.device)
...
if __name__=="__main__":
    ...
    preddataPath = r"/media/wucong/225A6D42D4FA828F1/datas/PennFudanPed/PNGImages"
    ...
    cfg["network"]["RPN"]["num_boxes"] = 1 # must be 1
